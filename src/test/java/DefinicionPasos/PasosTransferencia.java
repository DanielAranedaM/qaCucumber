...
@Then("El mensaje de resultados {string} debe contener \"{double} was successfully transferred")
public void el_mensaje_de_resultados_debe_contener_was_successfully_transferred(String string, Double double1) {
